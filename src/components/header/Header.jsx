        ...
        <header className='header' id='home'>
           <div className='header__slogan'>
            ...
            <div className='header__slogan__media'>
                ...
                <a href='https://www.youtube.com/channel/UCFnyUE8WoNdBnonSBCVGzRA/videos' target='_blank'><img src={youtube} className='header__slogan__media--instagram' /></a>
                <a href='https://www.instagram.com/gadz.it/' target="_blank"><img src={instagram} className='header__slogan__media--youtube' /></a>
            </div>
           </div>
