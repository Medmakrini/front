...
import teaching from '../../assets/svgs/teaching-coding.svg';
        ...
        <div className='our-courses' id='courses'>
            ...
            <div className='our-courses__main'>
                ...
                <div className='our-courses__main__description'>
                    ...
                    <Link type='button' className='our-courses__main__description__registration' to='/formation-form'>Registration <img src={row} /></Link>
                </div>
            </div>
            ...
            <Link type='button' className='our-courses__registration--sub' to='/formation-form'>Registration <img src={row} /></Link>
        </div>
    );
}
