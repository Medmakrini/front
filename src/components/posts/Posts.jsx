...
function Posts({blogs}) {
    ...
    return (
        <div className='activities' id='blogs'>
            <div className='activities__heading'><div><img src={fire}/>Our Blogs</div><Link to='/blogs' type='button' className='activities__heading__show-all'>Show all<img src={row} /></Link></div>
